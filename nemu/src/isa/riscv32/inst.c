...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, isa_csr_display(); s->dnpc = csr.mepc; csr.mstatus.m[0] = (csr.mstatus.m[0] & 0x8) | (csr.mstatus.m[1] & 0x8); csr.mstatus.m[1] |= 0x8; isa_csr_display());
