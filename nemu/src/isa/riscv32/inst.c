...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, printf("%x %x %llx %llx\n", src1, src2, (long long)src1, (long long)src2) ;helper = (int64_t)src1 * (int64_t)src2; helper >>= 32; R(dest) = (int32_t) helper);
